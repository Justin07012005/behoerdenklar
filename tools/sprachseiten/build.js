...
function seite(s) {
  ...
  return vorlage
    ...
    .replace(/\{\{CTA_DEMO\}\}/g, t.ctaDemo)
    .replace(/\{\{CTA_KAUF\}\}/g, t.ctaKauf)
    .replace(/\{\{DEMO_HINWEIS\}\}/g, t.demoHinweis)
    .replace(/\{\{KAUF_TITEL\}\}/g, t.kaufTitel)
    .replace(/\{\{KAUF_H3\}\}/g, t.kaufH3)
    .replace(/\{\{KAUF_TEXT\}\}/g, t.kaufText)
    .replace(/\{\{KAUF_EMAIL\}\}/g, t.kaufEmail)
    .replace(/\{\{KAUF_KONSENS\}\}/g, t.kaufKonsens)
    .replace(/\{\{KAUF_SICHER\}\}/g, t.kaufSicher)
    .replace(/\{\{PAKET_WORT\}\}/g, t.paketWort)
    .replace(/\{\{AUF_DEUTSCH\}\}/g, t.aufDeutsch)
    .replace(/\{\{KAUF_FEHLER_HAKEN\}\}/g, t.kaufFehlerHaken)
    .replace(/\{\{KAUF_FEHLER_ALLG\}\}/g, t.kaufFehlerAllg)
